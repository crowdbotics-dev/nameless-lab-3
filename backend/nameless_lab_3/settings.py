"""
Django settings for nameless_lab_3 project.
...
ROOT_URLCONF = 'nameless_lab_3.urls'
...
WSGI_APPLICATION = 'nameless_lab_3.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Nameless Lab Support <support@nameless-lab-3.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "nameless_lab_3 API",
    "DESCRIPTION": "API documentation for nameless_lab_3 App",
    "VERSION": "v1",
}
